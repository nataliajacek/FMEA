...
st.subheader("Optional: Upload Files / Images for AI to analyze")
    ...
    for file in files:
        ...
        if file.type == "application/pdf":
            ...
            vision_prompt = [
                {
                    "type": "text",
                    "text": "Extract all technical information from this image including parts, specs, requirements, diagrams, labels."
                },
                {
                    "type": "image_url",
...
if uploaded_files:
    with st.spinner("Reading uploaded files..."):
        file_text = extract_file_content(uploaded_files)
...
Extra information extracted from uploaded files:
{file_text}
